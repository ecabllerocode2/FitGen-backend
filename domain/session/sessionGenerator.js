...
function buildMainBlock({
  ...
  return exercises
    ...
    return {
      ...
      imageUrl: ex.url_img_0 ?? ex.imageUrl ?? (ex.id ? `https://pub-8d5fa4786e4142aab39adba9d49ee865.r2.dev/${ex.id}_0.webp` : null),
      imageUrl2: ex.url_img_1 ?? ex.imageUrl2 ?? (ex.id ? `https://pub-8d5fa4786e4142aab39adba9d49ee865.r2.dev/${ex.id}_1.webp` : null),
