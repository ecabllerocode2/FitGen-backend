...
const AVATAR_STARTING_BUILDS = new Set(['soft', 'slender', 'ectomorph']);
...
function normalizeInjuries(raw) {
  ...
  const profile = {
    ...
    musclePriorities: Array.isArray(raw.musclePriorities)
      ...
      : [],
    ...(AVATAR_STARTING_BUILDS.has(raw.avatarStartingBuild)
      ? { avatarStartingBuild: raw.avatarStartingBuild }
      : {}),
