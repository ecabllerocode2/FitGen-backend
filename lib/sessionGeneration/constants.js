...
export const MOVEMENT_PATTERN_MAP = {
    ...
    'Pull': ['Traccion_H', 'Traccion_V'],
    'Push': ['Empuje_H', 'Empuje_V'],
    'Legs': ['Rodilla', 'Cadera'],
    ...
    'Cuerpo completo': ['Rodilla', 'Cadera', 'Empuje_H', 'Traccion_V', 'Core'],
...
export const MUSCLE_FOCUS_MAP = {
    ...
    'Cuerpo completo': ['Cuádriceps', 'Glúteos', 'Isquiotibiales','Pecho', 'Espalda', 'Core', 'Hombros', 'Tríceps', 'Bíceps'],
    'Core/Cardio': ['Core'],
