 ...
 */
export function construirBloqueCore(ejerciciosCore, nivel, rpeObjetivo, contextualData, readinessAdjustments) {
    ...
    // ====================================================================
    // 2. SELECCIONAR EJERCICIOS BALANCEADOS
    // ====================================================================
 ...
 */
function seleccionarEjerciciosCore(ejerciciosPorPatron, cantidad, nivel, contextualData) {
    const seleccionados = [];
    ...
    // Prioridad de patrones según principios de McGill
